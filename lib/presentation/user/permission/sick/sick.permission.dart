...
import 'package:traxes/presentation/user/permission/sick/search.outlet.sick.screen.dart';

class SickPermissionScreen extends StatefulWidget {
  final String? customerId;
  final String? customerName;
  const SickPermissionScreen({super.key, this.customerId, this.customerName});

  @override
  State<SickPermissionScreen> createState() => _SickPermissionScreenState();
}

class _SickPermissionScreenState extends State<SickPermissionScreen> {
  File? imageAbsence;
  Position? position;
  String? bytes;
  double? distance;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: GradientAppBar(
        title: Text("Submit Izin Sakit", style: standarWhiteTextB),
      ),
                                      ...
                                      TextButton(
                                        ...
                                        child:
                                         ...
                                         CoolAlert.show(
                                          ...
                                          confirmBtnText: "Ajukan izin sakit",
                                          ...
                                          title:
                                              "Pastikan keterangan sakit dan foto surat keterangan dokternya jelas ya :)",
