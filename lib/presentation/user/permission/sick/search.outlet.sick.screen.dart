...
class SickOutletScreen extends StatefulWidget {
  const SickOutletScreen({super.key});

  @override
  State<SickOutletScreen> createState() => _SickOutletScreenState();
}

class _SickOutletScreenState extends State<SickOutletScreen> {
