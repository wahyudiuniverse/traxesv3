...
class LeaveOutletScreen extends StatefulWidget {
  const LeaveOutletScreen({super.key});

  @override
  State<LeaveOutletScreen> createState() => _LeaveOutletScreenState();
}

class _LeaveOutletScreenState extends State<LeaveOutletScreen> {
